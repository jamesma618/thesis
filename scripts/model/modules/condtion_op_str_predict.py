...
class CondOpStrPredictor(nn.Module):
    def __init__(self, N_word, N_h, N_depth, max_col_num, max_tok_num, gpu):
        ...
        self.cond_opstr_lstm = nn.LSTM(input_size=N_word, hidden_size=N_h/2,
    ...
    def forward(self, x_emb_var, x_len, col_inp_var, col_len,
        ...
        if gt_cond is None:
            ...
            _, cond_num_score, _, cond_col_score, _, _ , _ , _ , _ , _ , _ , _  = sel_cond_score
        ...
        h_enc, _ = run_lstm(self.cond_opstr_lstm, x_emb_var, x_len)
